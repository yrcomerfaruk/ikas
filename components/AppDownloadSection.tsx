...
const AppDownloadSection = () => {
  return (
    <section className="py-12 bg-gradient-to-r from-green-600 to-yellow-600">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between">
          <div className="text-white mb-8 lg:mb-0 lg:w-1/2">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-black text-white px-6 py-3 rounded-lg flex items-center justify-center space-x-2">
